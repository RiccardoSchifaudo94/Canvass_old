     ...
     <div class="uk-margin-large-bottom">    
        ...
        <?php
...

            {
              ...
              $sql = "SELECT * FROM delibere INNER JOIN eletto 
               ...
               AND delibere.cancellato='NO' ".$stringaCosto.$stringaLivello." ORDER BY ID_delibera DESC;";
...

            {
              ...
              $sql = "SELECT * FROM delibere INNER JOIN eletto ON delibere.ID_eletto=eletto.ID_eletto WHERE eletto.cancellato='NO' AND delibere.cancellato='NO' "

                      . "AND delibere.confermato = 'SI' AND delibere.stato = 'Confermata' ORDER BY ID_delibera DESC;";
       ...
       ?>  
        ...
        <br>
            ...
            <center><h2>Bacheca delle Delibere - Recenti</h2></center>

                

                            <ul class="uk-subnav uk-subnav-pill" aling="right">

                                <li class="uk-active"><a href="../bachecaDelibere/dashboard_delibera.php"><i class="uk-icon-calendar"></i> Recenti</a></li>
