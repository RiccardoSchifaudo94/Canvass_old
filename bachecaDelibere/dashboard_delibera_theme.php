        ...
        <?php
...

            {
              ...
              if($_POST['ID_tema']!="-")
                ...
                $stringaTema = " AND delibere.ID_tema = '$ID_tema'";
              ...
              $sql = "SELECT * FROM delibere INNER JOIN eletto 
               ...
               WHERE delibere.confermato = 'SI' AND delibere.stato = 'Confermata' AND delibere.titolo LIKE '%$titolo%' AND eletto.cancellato='NO'  

               AND delibere.cancellato='NO' ".$stringaCosto.$stringaLivello.$stringaTema." ORDER BY ID_delibera DESC;";
                            ...
                            <div class="uk-alert uk-alert-success" data-uk-alert>
                              ...
                              <a href="" class="uk-alert-close uk-close"></a>
...

                               {
                                ...
                                $sql_tema = "SELECT * FROM tema WHERE cancellato = 'NO' AND ID_tema = '$ID_tema';";

                                $row_tema = esegui_query_stringa($con,$sql_tema);

                                echo "<br><b>Tema Categoria: </b>".$row_tema['nome'];
...

            {
              ...
              $sql = "SELECT * FROM delibere INNER JOIN eletto ON delibere.ID_eletto=eletto.ID_eletto "
                      ...
                      . " eletto.cancellato='NO' AND delibere.cancellato='NO' ORDER BY ID_delibera DESC;";
        ...
        <br>
            ...
            <center><h2>Bacheca delle Delibere - Popolari</h2></center>
                            ...
                            <ul class="uk-subnav uk-subnav-pill" aling="right">
                                ...
                                <li><a href="../bachecaDelibere/dashboard_delibera_popular.php"><i class="uk-icon-sort-amount-desc"></i> Popolari</a></li>

                                <li class="uk-active"><a href="../bachecaDelibere/dashboard_delibera_theme.php"><i class="uk-icon-key"></i> Tematiche</a></li>
...

          {
            ...
            ?>
              ...
              <form action="dashboard_delibera_theme.php" method="post">

               <div class="uk-grid">

              

                    <div class="uk-width-small-1-4 uk-width-medium-1-4">
                      ...
                      <div class="uk-width-small-1-4 uk-width-medium-1-4">
                       ...
                       <div class="uk-width-small-1-4 uk-width-medium-1-4">
                             ...
                             <label>Tema Categoria</label>
                                 ...
                                 <select name="ID_tema" class="uk-form-select uk-form-large uk-width-1-1">
                                  ...
                                  $sql_cerca = "SELECT * FROM tema WHERE cancellato = 'NO';";
                                  ...
                                  while ($row_cerca = mysqli_fetch_assoc($ris_cerca))

                                   {
                                    ...
                                    <option value="<?php echo filtraOutput($row_cerca['ID_tema']);?>"><?php echo filtraOutput($row_cerca['nome']); ?></option>
...

          {
            ...
            ?>
              ...
              <form action = "dashboard_delibera_theme.php" method="post">
                        ...
                        <button class="uk-button uk-button-primary correct_btn_search" type="submit"><i class="uk-icon-search"></i> Cerca Delibera</button>  
