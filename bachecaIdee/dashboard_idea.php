...
?>    
 <?php 
     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       ?>  
        <br>
            <center><h2>Bacheca delle Idee - Recenti</h2></center>
          
                 <ul class="uk-subnav uk-subnav-pill" aling="right">
                        <li class="uk-active"><a href="../bachecaIdee/dashboard_idea.php"><i class="uk-icon-calendar"></i> Recenti</a></li>
                        <li><a href="../bachecaIdee/dashboard_idea_popular.php"><i class="uk-icon-sort-amount-desc"></i> Popolari</a></li>
                        <li><a href="../bachecaIdee/dashboard_idea_theme.php"><i class="uk-icon-key"></i> Tematiche</a></li>
                    </ul>
          ...
          <?php
                      ...
                      $sql = "SELECT * FROM idee INNER JOIN utente ON idee.ID_utente=utente.ID_utente WHERE utente.cancellato='NO' AND idee.cancellato='NO' ORDER BY ID_idea DESC;";
