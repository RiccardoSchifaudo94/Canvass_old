    ...
    <?php   
          ...
          $ID_idea = pulisci($_POST['ID_idea']);
            ...
            if($ID_idea!="")
              $stato = 0;
            if($stato==1)
            header("location:agenda_idee.php");
     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        <br>
              ...
              <center><h2>Visualizza Idea in Agenda</h2></center>
                    ...
                    <div class="uk-width-medium-1-4">
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-medium-1-1">
                              ...
                              $ID_idea = pulisci($_POST['ID_idea']);
                              $con = connetti("my_canvass");
                              $sql_contatto_utente = "SELECT * FROM idee WHERE cancellato = 'NO' AND ID_idea = '$ID_idea';";
                              $row_contatto_utente = esegui_query_stringa($con,$sql_contatto_utente);
                              $ID_contatto = filtraOutput($row_contatto_utente['ID_utente']);

                              ?>
                               <form action="../messaggistica/scrivi2.php" method="post">
                                  <input type="hidden" name="ID_contatto" value="<?php echo filtraOutput($ID_contatto);?>">
                                  <button class="uk-button uk-button-success"><i class="uk-icon-edit"></i> Contatta Utente</button>
                                </form>
                                <br> 
                               <form action="trasforma_idea_in_delibera.php" method="post">
                                  <input type="hidden" name="ID_idea" value="<?php echo filtraOutput($_POST['ID_idea'])?>">
                                  <button class="uk-button uk-button-primary"><i class="uk-icon-level-up"></i> Crea delibera idea</button>
                                </form>
                                <br> 
                                <?php
