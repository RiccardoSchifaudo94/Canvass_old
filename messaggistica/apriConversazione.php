...
<html lang="en-gb" dir="ltr" class="uk-height-1-1">
    ...
    <?php   
          ...
          if($ID_messaggio_gruppo!="")

            $stato = 0;

          if($stato==1)

          header("location:conversazioni.php");
...
?>     
     ...
     <div class="uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        <center><h2>Messaggistica - Apri Conversazione</h2></center>
        ...
        <div class="uk-form">
            ...
            //s$ID_messaggio_gruppo = $_POST['ID_messaggio_gruppo'];

            $sql = "SELECT * FROM messaggio WHERE ID_messaggio_gruppo = '$ID_messaggio_gruppo' ORDER BY ID_messaggio DESC;";

            $ris = esegui_query($con,$sql);



            $sql_tema = "SELECT * FROM messaggio WHERE cancellato = 'NO' AND ID_messaggio_gruppo='$ID_messaggio_gruppo';";
            ...
            <center><h4><?php  echo "Titolo Conversazione:<br><h3>".$row_tema['oggetto']."</h3>";?><h4></center>
            ...
            <table width="100%" class="table">
              ...
              ?>
                ...
                <tr><th><br><br>Inviato da:</th><td><br><br><?php echo $row_mitt['nome']." ".$row_mitt['cognome'];?></td></tr>
                ...
                <tr><th>Testo</th><td><?php echo $row['testo'];?></td></tr>
