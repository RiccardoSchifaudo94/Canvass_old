     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        <?php   //  --------------------------------------- AREA DEI TOKEN DI ESECUZIONE -------------------------------------------?>
            ...
            <?php
            if(isset($_POST['token_cancella_conversazione2'])){

              $con =connetti("my_canvass");

              $sql3 ="UPDATE messaggio_gruppo SET cancellato='SI' WHERE ID_messaggio_gruppo='".filtraInput($con,$_POST['ID_messaggio_gruppo'])."';";
             //echo $sql3."<br>";
                     ...
                     <div class="uk-width-medium-2-4 uk-width-small-2-4">
                        <div class="uk-alert uk-alert-success" data-uk-alert>
                          <a href="" class="uk-alert-close uk-close"></a>
                           <strong>Conversazione Cancellata!</strong>
                           <p align="center"> Questa conversazione e' stata spostata nel cestino.</p>
                     </div> 
                     <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
                     </div> 
                    </center>
            ...
            <?php 
              ...
              if(isset($_POST['token_cancella_conversazione']))
              {
                      ...
                      <div class="uk-grid">
                       ...
                       <div class="uk-width-medium-2-4 uk-width-small-2-4">
                          <div class="uk-alert uk-alert-danger" data-uk-alert>
                            <a href="" class="uk-alert-close uk-close"></a>
                             <strong>Sei sicuro cancellare questa conversazione?</strong>
                             <p align="center"> La conversazione verrà spostata nel cestino .</p>
                             <br>
                            <br>
                            <div class="uk-grid">
                              <div class="uk-width-medium-4-10 uk-width-small-4-10"></div>
                              <div class="uk-width-medium-1-10 uk-width-small-1-10">
                                    <form action="archiviati.php" method="post">
                                    <input type='hidden' name='ID_messaggio_gruppo' value="<?php echo filtraOutput($_POST['ID_messaggio_gruppo']);?>">
                                    <input type='hidden' name='token_cancella_conversazione2' value="1">
            ...
            <?php
            if(isset($_POST['token_ripristina_conversazione2'])){

              $con =connetti("my_canvass");

              $sql3 ="UPDATE messaggio_gruppo SET archiviato='NO' WHERE ID_messaggio_gruppo='".filtraInput($con,$_POST['ID_messaggio_gruppo'])."';";
             //echo $sql3."<br>";
              $rs =esegui_query($con,$sql3);
            ...
            <div class="uk-grid">
             ...
             <div class="uk-width-medium-2-4 uk-width-small-2-4">
                <div class="uk-alert uk-alert-success" data-uk-alert>
                  <a href="" class="uk-alert-close uk-close"></a>
                      <strong>Conversazione Ripristinata!</strong>
                      <p align="center"> Questa conversazione e' stata riaperta.</p>
             </div> 
             <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
             </div> 
            </center>
            ...
            <?php 
              ...
              if(isset($_POST['token_ripristina_conversazione']))
              {
                      ...
                      <div class="uk-grid">
                       ...
                       <div class="uk-width-medium-2-4 uk-width-small-2-4">
                          <div class="uk-alert uk-alert-info" data-uk-alert>
                            <a href="" class="uk-alert-close uk-close"></a>
                             <strong>Vuoi rispristinare questa conversazione?</strong>
                             <p align="center"> In questo modo riaprirai questa conversazione.</p>
                             <br>
                            <br>
                            <div class="uk-grid">
                              <div class="uk-width-medium-4-10 uk-width-small-4-10"></div>
                              <div class="uk-width-medium-1-10 uk-width-small-1-10">
                                   <form action="archiviati.php" method="post">
                                    <input type='hidden' name='ID_messaggio_gruppo' value="<?php echo filtraOutput($_POST['ID_messaggio_gruppo']);?>">
                                    <input type='hidden' name='token_ripristina_conversazione2' value="1">
                                     <button class='uk-button uk-button-danger' type='submit'>SI</button>
                                  </form> 
                              </div>
                              <div class="uk-width-medium-1-10 uk-width-small-1-10">
        ...
        <center><h2>Messaggistica - Archivio</h2></center>
        <br>
        <div class="uk-form">
        ...
        <table class="uk-table">
              ...
              <thead>
                    <tr>
                        <th>Mittente</th><th>Oggetto</th><th>Data Invio</th><th>Ripristina</th><th>Cancella</th>
                    </tr>
              </thead>         
              <tbody>
              ...
              <?php
                    ...
                    $sql_estrai = "SELECT * FROM messaggio_gruppo WHERE  archiviato = 'SI' AND cancellato = 'NO';";
                    $ris_estrai = esegui_query($con,$sql_estrai);

                    while($row_estrai = mysqli_fetch_assoc($ris_estrai))
                    { 

                    $sql_visualizza = "SELECT * FROM messaggio WHERE cancellato = 'NO' AND ID_messaggio_gruppo = '".$row_estrai['ID_messaggio_gruppo']."' GROUP BY ID_messaggio_gruppo ORDER BY ID_messaggio DESC;";
                  ...
                  <td> 
                    <form action="archiviati.php" method="post">
                      ...
                      <input type="hidden" name="token_ripristina_conversazione" value="1">
                      <button class="uk-button uk-button-success" type="submit"><i class="uk-icon-folder-open"></i></button>
                    </form>
                  </td>
                  <td>  
                    <form action="archiviati.php" method="post">
                      ...
                      <input type="hidden" name="ID_messaggio" value="<?php echo $row['ID_messaggio'];?>">
                      <input type="hidden" name="ID_utente" value="<?php echo $ID_utente; ?>">
                      <input type="hidden" name="token_cancella_conversazione" value="1">
