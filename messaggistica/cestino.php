...
?>     
     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       <?php
                if(isset($_POST['token_rimozione_totale2'])){

                  $con =connetti("my_canvass");

                  $sql3 ="DELETE FROM messaggio WHERE cancellato = 'SI' AND mittente='$ID_utente' OR destinatario = '$ID_utente';";
                 //echo $sql3."<br>";
                  ...
                  <div class="uk-grid">
                   ...
                   <div class="uk-width-medium-2-4 uk-width-small-2-4">
                      <div class="uk-alert uk-alert-success" data-uk-alert>
                        ...
                        <strong>Rimozione Totale Avvenuta!</strong>
                        <p align="center"> Tutti i tuoi messaggi presenti nel cestino sono stati cancallati definitivamente!</p>
                   </div> 
                   <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
                   </div> 
                  </center>
                ...
                <?php 
                  ...
                  if(isset($_POST['token_rimozione_totale']))
                  {
                      ...
                      <div class="uk-grid">
                       ...
                       <div class="uk-width-medium-2-4 uk-width-small-2-4">
                          <div class="uk-alert uk-alert-danger" data-uk-alert>
                            <a href="" class="uk-alert-close uk-close"></a>
                              <strong>Rimozione Totale! Sei Sicuro?</strong>
                              <p align="center"> Tutti i messaggi presenti nel cestino verrano eliminati definitivamente .</p>
                              <br>
                            <br>
                            <div class="uk-grid">
                              <div class="uk-width-medium-4-10 uk-width-small-4-10"></div>
                              <div class="uk-width-medium-1-10 uk-width-small-1-10">
                                  <form action="cestino.php" method="post">
                                        <input type='hidden' name='token_rimozione_totale2' value="1">
                ...
                ?>
                  ...
                  <?php
                if(isset($_POST['token_rimuovi_messaggio2'])){

                  $con =connetti("my_canvass");

                  $sql3 ="DELETE FROM messaggio  WHERE ID_messaggio='".filtraInput($con,$_POST['ID_messaggio'])."';";
                 //echo $sql3."<br>";
                  $rs =esegui_query($con,$sql3);
                ...
                ?>
                  ...
                  <div class="uk-grid">
                   ...
                   <div class="uk-width-medium-2-4 uk-width-small-2-4">
                      <div class="uk-alert uk-alert-success" data-uk-alert>
                        <a href="" class="uk-alert-close uk-close"></a>
                        <strong>Messaggio Rimosso!</strong>
                      <p align="center"> Questo messaggio e' stata rimosso definitivamente.</p>
                   </div> 
                   <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
                   </div> 
                  </center>
                ...
                <?php 
                  ...
                  if(isset($_POST['token_rimuovi_messaggio']))
                  {
                    ...
                    ?>
                      ...
                      <div class="uk-grid">
                       ...
                       <div class="uk-width-medium-2-4 uk-width-small-2-4">
                          <div class="uk-alert uk-alert-danger" data-uk-alert>
                            <a href="" class="uk-alert-close uk-close"></a>
                              <strong>Vuoi rimuovere questo messaggio?</strong>
                              <p align="center"> In questo modo elimini definitivamente il messagggio.</p>
                              <br>
                            <br>
                            <div class="uk-grid">
                              <div class="uk-width-medium-4-10 uk-width-small-4-10"></div>
                              <div class="uk-width-medium-1-10 uk-width-small-1-10">
                                  <form action="cestino.php" method="post">
                                        ...
                                        <input type='hidden' name='token_rimuovi_messaggio2' value="1">
                                     <button class='uk-button uk-button-danger' type='submit'>SI</button>
                                  </form> 
                              </div>
                              <div class="uk-width-medium-1-10 uk-width-small-1-10">
                ...
                <?php
                if(isset($_POST['token_ripristina_messaggio2'])){

                  $con =connetti("my_canvass");

                  $sql3 ="UPDATE messaggio SET  cancellato = 'NO' WHERE ID_messaggio='".filtraInput($con,$_POST['ID_messaggio'])."';";
                 //echo $sql3."<br>";
                  $rs =esegui_query($con,$sql3);
                ...
                <div class="uk-grid">
                 ...
                 <div class="uk-width-medium-2-4 uk-width-small-2-4">
                    <div class="uk-alert uk-alert-success" data-uk-alert>
                      <a href="" class="uk-alert-close uk-close"></a>
                     <strong>Messaggio Ripristinato!</strong>
                      <p align="center"> Questo messaggio e' stata riaperto.</p>
                 </div> 
                 <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
                 </div> 
                </center>
                ...
                <?php 
                  ...
                  if(isset($_POST['token_ripristina_messaggio']))
                  {
                      ...
                      <div class="uk-grid">
                       ...
                       <div class="uk-width-medium-2-4 uk-width-small-2-4">
                          <div class="uk-alert uk-alert-info" data-uk-alert>
                            <a href="" class="uk-alert-close uk-close"></a>
                               <strong>Vuoi rispristinare questo messaggio?</strong>
                               <p align="center"> In questo modo ripristini il messagggio.</p>
                               <br>
                            <br>
                            <div class="uk-grid">
                              <div class="uk-width-medium-4-10 uk-width-small-4-10"></div>
                                            <div class="uk-width-medium-1-10 uk-width-small-1-10">
                                              <form action="cestino.php" method="post">
                                                   <input type='hidden' name='ID_messaggio' value="<?php echo filtraOutput($_POST['ID_messaggio']);?>">
                                                   <input type='hidden' name='token_ripristina_messaggio2' value="1">
                                                <button class='uk-button uk-button-danger' type='submit'>SI</button>
                                             </form> 
                                            </div>
                                            <div class="uk-width-medium-1-10 uk-width-small-1-10">
        ...
        <center><h2>Messaggistica - Cestino</h2></center>
        <br>
        <div class="uk-form">
        ...
        <div class="uk-form">
            <form action="cestino.php" method="post">
                  <input type="hidden" name="token_rimozione_totale" value="1"> 
                  <input type="hidden" name="ID_utente" value="<?php echo $ID_utente; ?>">  
                  <button class="uk-button uk-button-danger" type="submit"><i class="uk-icon-remove"></i> Rimuovi Tutti</button>
            </form>  
        </div> 
        <br>
           ...
           <table class="uk-table"> 
            <thead> 
            <tr><th>Mittente</th><th>Oggetto</th><th>Data Invio</th><th>Ripristina</th><th>Rimuovi</th></tr>
            </thead>
            ...
            <?php
              ...
              $sql_visualizza = "SELECT * FROM messaggio WHERE cancellato = 'SI' ORDER BY ID_messaggio DESC;";
            ...
            <td width="1%">
              ...
              <form action="cestino.php" method="post">
                ...
                <input type="hidden" name="ID_utente" value="<?php echo $ID_utente; ?>">
                <input type="hidden" name="token_ripristina_messaggio" value="1">
            ...
            <td width="1%">
              ...
              <form action="cestino.php" method="post">
                ...
                <input type="hidden" name="ID_messaggio" value="<?php echo $row['ID_messaggio'];?>">
                <input type="hidden" name="ID_utente" value="<?php echo $ID_utente; ?>">
                <input type="hidden" name="token_rimuovi_messaggio" value="1">
