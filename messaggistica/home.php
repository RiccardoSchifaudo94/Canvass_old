     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        <?php   //  --------------------------------------- AREA DEI TOKEN DI ESECUZIONE -------------------------------------------?>
                ...
                <?php
                      if(isset($_POST['token_cancella_messaggio2'])){

                        $ID_messaggio = pulisci($_POST['ID_messaggio']);
                        $con =connetti("my_canvass");


                        $sql4 ="UPDATE messaggio SET cancellato='SI' WHERE ID_messaggio='".pulisci($_POST['ID_messaggio'])."';";
                       // echo $sql4."<br>";
                        $ris = esegui_query($con,$sql4);
                          ...
                          <div class="uk-grid">
                           ...
                           <div class="uk-width-medium-2-4 uk-width-small-2-4">
                              <div class="uk-alert uk-alert-success" data-uk-alert>
                                ...
                                <strong>Messaggio cancellato!</strong>
                                <br>Questa maessaggio e' stato cancellata con successo<br>
                              </div>
                           </div> 
                           <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
                           </div> 
                    ...
                    if(isset($_POST['token_rispondi']))
                    {

                    //$ID_utente = $_POST['ID_utente'];

                    $con = connetti("my_canvass");
                    $destinatario = pulisci($_SESSION['destinatario']);
                    $oggetto = pulisci($_POST['oggetto']);
                    $testo  = pulisci($_POST['testo']);
                    $mittente = $ID_utente;
                    $ID_messaggio_gruppo = pulisci($_POST['ID_messaggio_gruppo']);

                    $sql_rispondi = "INSERT INTO messaggio (ID_messaggio_gruppo,mittente,destinatario,oggetto,testo)VALUES('$ID_messaggio_gruppo','$mittente','$destinatario','$oggetto','$testo');";
                    $ris_rispondi = esegui_query($con,$sql_rispondi);
                    //echo $sql_rispondi;
                                
                                    $ID_messaggio_ultimo = mysqli_insert_id($con);
                                                        
                                    $sql_notifica_msg = "INSERT INTO notifica(ID_utente,tipo) VALUES ('$destinatario','Risposta_Messaggio');";
                                    $ris_notifica_msg = esegui_query($con, $sql_notifica_msg);

                                    $ID_notifica_ultima = mysqli_insert_id($con);

                                    $sql_associa_notifica_messaggio = "INSERT INTO associa_notifica_messaggio(ID_notifica,ID_messaggio,ID_utente) VALUES ('$ID_notifica_ultima','$ID_messaggio_ultimo','$ID_utente');";
                                    $ris_associa_notifica_messaggio = esegui_query($con, $sql_associa_notifica_messaggio);
                              ...
                              <div class="uk-grid">
                               ...
                               <div class="uk-width-medium-2-4 uk-width-small-2-4">
                                  <div class="uk-alert uk-alert-success" data-uk-alert>
                                    ...
                                    <br>La risposta al messaggio e' stata inviata correttamente<br>
                                  </div>
                               </div> 
                               <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
                               </div> 
              ...
              <?php
                    ...
                    if(isset($_POST['token_invia']))
                    {

                    $con = connetti("my_canvass");
                    $sql_gruppo = "INSERT INTO messaggio_gruppo() VALUES ();";
                    $ris_gruppo = esegui_query($con,$sql_gruppo);
                    $ultimo = mysqli_insert_id($con);

                    //$ID_utente = $_POST['ID_utente'];

                    $mittente = $ID_utente;
                    $destinatario = pulisci($_POST['destinatario']);
                    $testo = pulisci($_POST['testo']);
                    $oggetto = pulisci($_POST['oggetto']);


                    $sql_invia = "INSERT INTO messaggio(ID_messaggio_gruppo,mittente,destinatario,oggetto,testo)VALUES('$ultimo','$mittente','$destinatario','$oggetto','$testo');";
                    $ris_invia = esegui_query($con,$sql_invia);
                    //echo $sql_invia;
                                                  $ID_messaggio_ultimo = mysqli_insert_id($con);
                                                  
                                                  $sql_notifica_msg = "INSERT INTO notifica(ID_utente,tipo) VALUES ('$destinatario','Messaggio');";
                                                  $ris_notifica_msg = esegui_query($con, $sql_notifica_msg);
                              ...
                              <div class="uk-grid">
                               ...
                               <div class="uk-width-medium-2-4 uk-width-small-2-4">
                                  <div class="uk-alert uk-alert-success" data-uk-alert>
                                    ...
                                    <br>Il messaggio e' stata inviato correttamente<br>
                                  </div>
                               </div> 
                               <div class="uk-width-medium-1-4 uk-width-small-1-4"></div>
                               </div> 
        ...
        <center><h2>Messaggistica - Home</h2></center>
        <br>
        <div class="uk-form">
        ...
        <thead>
            <tr>
                <th>Mittente</th><th>Oggetto</th><th>Data Invio</th><th>Apri</th><th>Cancella</th>
            </tr>
       </thead>         
        <tbody>
            <?php
            ...
            $sql_visualizza = "SELECT * FROM messaggio WHERE cancellato = 'NO' AND mittente = '$ID_utente' OR destinatario = '$ID_utente' ORDER BY ID_messaggio DESC;";
