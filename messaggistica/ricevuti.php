 ...
 <?php 
     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
                       ...
                       <div class="uk-width-medium-2-4 uk-width-small-2-4">
                          ...
                          <br>
                            ...
                            <div class="uk-grid">
                              ...
                              <div class="uk-width-medium-1-10 uk-width-small-1-10">
                                    <form action="ricevuti.php" method="post">
        ...
        <center><h2>Messaggistica - Ricevuti</h2></center>
        <br>
        <div class="uk-form">
        ...
        <tbody>
            ...
            $sql_visualizza = "SELECT * FROM messaggio WHERE cancellato = 'NO' AND destinatario = '$ID_utente' ORDER BY ID_messaggio DESC;";
