...
?>     
     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        <center><h2>Messaggistica - Scrivi Messaggio</h2></center>
        <br>
        <div class="uk-form">
        ...
        <div class="uk-form-row">
          ...
          <br>
          <select name="destinatario" class="uk-form-select uk-width-small-1-1 uk-width-medium-1-1 uk-form-large">
                <?php

                $ID_contatto = pulisci($_POST['ID_contatto']);

                $con = connetti("my_canvass");
                $sql_utente = "SELECT * FROM utente WHERE ID_utente = '$ID_contatto';";
                ...
                if($ID_utente!=$row_utente['ID_utente'])
                  {
            ...
            <div class="uk-form-row">
              <label>Oggetto</label>
              <br>
              <input name="oggetto" class="uk-width-small-1-1 uk-width-medium-1-1 uk-form-large" type="text">
            </div>  
            <br>
            <div class="uk-form-row">
              <label>Testo</label>
              <br>
              <textarea name="testo" class="uk-width-small-1-1 uk-width-medium-1-1" type="text" rows="10"></textarea>
            </div>
            <br>
            <input type="hidden" name="token_invia" value="1">
            <input type="hidden" name="ID_utente" value="<?php echo $ID_utente; ?>">
            <button class="uk-button uk-button-primary" type="submit"><i class="uk-icon-paper-plane-o"></i> Invia</button>
            </form>
