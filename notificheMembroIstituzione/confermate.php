       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        <?php   //  --------------------------------------- AREA DEI TOKEN DI ESECUZIONE -------------------------------------------?>
          ...
          <?php
            ...
            if(isset($_POST['token_setta_notifica_delibere_confermate'])){

              $con =connetti("my_canvass");
              $ID_notifica = pulisci($_POST['ID_notifica']);
              $sql3 ="UPDATE notifica SET letto ='SI' WHERE ID_notifica='$ID_notifica' AND tipo = 'Delibera_confermata';";
             // echo $sql3."<br>";
        ...
        <br>
            <center><h2>Notifiche - Delibere Confermate</h2></center>
            <div class="uk-container-overflow">
                  <table class="uk-table">
                     ...
                     <tbody>
                      <?php   
                      $con = connetti("my_canvass");
                      $sql = "SELECT * FROM notifica WHERE  ID_utente = '$ID_utente' AND letto = 'NO' AND tipo = 'Delibera_confermata';";
                      ...
                      while($row = mysqli_fetch_assoc($ris))
                      {
                          ...
                          $sql_dettaglio = "SELECT associa_notifica_delibera.ID_notifica, "
                                  ...
                                  . " AND notifica.tipo = 'Delibera_confermata' AND associa_notifica_delibera.ID_notifica = '".$row['ID_notifica']."';";
                         ...
                         // echo $sql_dettaglio."<br>";
                          while($row_dettaglio = mysqli_fetch_assoc($ris_dettaglio))
                          {
                             ...
                             //echo $sql_delibera."<br>";
                              ...
                              echo "<td><b>".$row_utente['nome']." ".$row_utente['cognome']."</b> ha confermato la tua delibera  <b>".$row_delibera['titolo']."</b></td>";
                             ?>
                             ...
                             <td width='1%' align='center'>
                                 <form action="confermate.php" method="post">
                                     <input type="hidden" name="token_setta_notifica_delibere_confermate" value="1">
