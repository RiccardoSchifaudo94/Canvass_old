       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        <?php
            ...
            if(isset($_POST['token_setta_notifica_suggerimenti'])){
              ...
              $sql3 ="UPDATE notifica SET letto ='SI' WHERE ID_notifica='$ID_notifica' AND tipo = 'Suggerimento_delibera' AND letto = 'NO';";
        ...
        <br>
            ...
            <table class="uk-table">
                     ...
                     <tbody>
                      ...
                      $sql = "SELECT * FROM notifica WHERE  ID_utente = '$ID_utente' AND letto = 'NO' AND tipo = 'Suggerimento_delibera';";
...

                      {
                             ...
                             $sql_dettaglio = "SELECT associa_notifica_delibera.ID_utente, "

                                     . "associa_notifica_delibera.ID_delibera,"

                                     . "associa_notifica_delibera.ID_notifica"

                                     . " FROM associa_notifica_delibera INNER JOIN delibere ON "

                                     . " associa_notifica_delibera.ID_delibera=delibere.ID_delibera "

                                     . "WHERE associa_notifica_delibera.ID_notifica = '".$row['ID_notifica']."';";

                             $row_dettaglio = esegui_query_stringa($con,$sql_dettaglio);
                             ...
                             // echo $sql_delibera."<br>";
                              ...
                              echo "<td><b>".$row_utente['nome']." ".$row_utente['cognome']."</b> ti ha inviato un suggerimento alla delibera  <b>".$row_delibera['titolo']."</b></td>";
                             ...
                             <td width='1%' align='center'>
                                 ...
                                 <form action="suggerimenti.php" method="post">
                                     ...
                                     <input type="hidden" name="ID_notifica" value="<?php  echo filtraOutput($row_dettaglio['ID_notifica']);?>">
