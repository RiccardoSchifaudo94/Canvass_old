     ...
     <div class="uk-container uk-container-center uk-margin-top uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
        ...
        //              --------------->>>>>>>>>>  SETTO IL SUGGERIMENTO COME LETTO ANCHE SE NON LO VISUALIZZO  <<<<<<----------------
         if(isset($_POST['token_setta_notifica_idee'])){

          $con =connetti("my_canvass");
          $ID_notifica = pulisci($_POST['ID_notifica']);
          $sql3 ="UPDATE notifica SET letto ='SI' WHERE ID_notifica='$ID_notifica' AND tipo ='Idea';";
          //echo $sql3."<br>";
        ...
        <br>
            <center><h2>Notifiche - Interessati</h2></center>
                 ...
                 <table class="uk-table">
                     ...
                     <tbody>
                       <?php   
                      $con = connetti("my_canvass");
                      $sql = "SELECT * FROM notifica WHERE  ID_utente = '$ID_utente' AND letto = 'NO' AND tipo = 'Idea';";
                      ...
                      while($row = mysqli_fetch_assoc($ris))
                      {
                          ...
                          $sql_dettaglio = "SELECT * FROM associa_notifica_idea WHERE ID_notifica = '".$row['ID_notifica']."';";
                          ...
                          while($row_dettaglio = mysqli_fetch_assoc($ris_dettaglio))
                          {
                              ...
                              echo "<td><b>".$row_utente['nome']." ".$row_utente['cognome']."</b> e' interessato alla tua idea <b>".$row_idea['titolo']."</b></td>";
                             ?>
                             ...
                             <td width='1%' align='center'>
                                 <form action="interessati.php" method="post">
                                     <input type="hidden" name="token_setta_notifica_idee" value="1">
