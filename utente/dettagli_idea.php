         ...
         <?php   
              ...
              //conto quanti soggetti sono interessati a portare avanti le mie idee
               ...
               <?php  
                ...
                /*---------------------->>>>>>>>>>>>>>>>>>>>>>> SETTA SUGGERIMENTI IDEA NON LETTI   <<<<<<<<<<<<<<<<<<<<<<<<--------------------*/



                $sql_ver_sugge_idea = "SELECT * FROM associa_suggerimento_idea WHERE ID_idea = '$ID_idea';";

                $ris_ver_sugge_idea = esegui_query($con,$sql_ver_sugge_idea);

                //echo $sql_ver_sugge_idea."<br>";

                while($row_ver_sugge_idea = mysqli_fetch_assoc($ris_ver_sugge_idea))

                {

                    

                  $sql_verifica = "SELECT * FROM associa_notifica_suggerimento "

                          . "WHERE ID_suggerimento = '".$row_ver_sugge_idea['ID_suggerimento']."';";

                  $ris_verifica = esegui_query($con,$sql_verifica);

                  //echo $sql_verifica."<br>";

                  while($row_verifica = mysqli_fetch_assoc($ris_verifica))

                  {

                      

                     $sql_setta_notifica_suggerimento = "UPDATE notifica SET letto = 'SI' "

                             . "WHERE letto = 'NO' AND ID_utente = '$ID_utente' AND tipo = 'Suggerimento' "

                             . "AND ID_notifica = '".$row_verifica['ID_notifica']."';";

                     $ris_setta_notifica_suggerimento = esegui_query($con, $sql_setta_notifica_suggerimento);

                    // echo $sql_setta_notifica_suggerimento."<br>"; 

                  }//close while di $row_verifica
                ...
                }//close while di $row_ver_sugge_idea
     ...
     <div class="uk-margin-large-bottom">    
       ...
       <nav class="uk-navbar uk-margin-large-bottom">
                 ...
                 <ul class="uk-nav uk-nav-offcanvas uk-nav-parent-icon" data-uk-nav>
                     ...
                     <li class="uk-parent">
                                ...
                                <ul class="uk-nav-sub">
                                    ...
                                    <li><a href="../messagistica/ricevuti.php"><i class="uk-icon-envelope-o"></i> Arrivati</a></li>

                                    <li><a href="../messagistica/scrivi.php"><i class="uk-icon-edit"></i> Scrivi</a></li>

                                    <li><a href="../messagistica/cestino.php"><i class="uk-icon-trash-o"></i> Cestino</a></li>
        ...
        <div class="uk-width-medium-4-6 uk-width-small-4-6">
             ...
             <center><h2>Dettagli Idea</h2></center>
                ...
                <div class="uk-width-medium-3-4">
                  ...
                  <br>
                    ...
                    <article class="uk-article">
                        ...
                        <p><?php if(empty($row['link']))echo "Nessuna link"; else echo "<a href='".filtraOutput($row['link'])."' target='_blank'>".filtraOutput($row['link'])."</a>";?></p>  
                    ...
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-medium-1-1">
                          ...
                          <br>
                           ...
                           <form action="visualizza_interessati.php" method="post">

                              <input type="hidden" name="ID_idea" value="<?php echo filtraOutput($_POST['ID_idea'])?>">

                              <button class="uk-button uk-button-primary"><i class="uk-icon-group"></i> Interessati Idea</button>
                            ...
                            <form action="modifica_idea.php" method="post">
                              ...
                              <button class="uk-button uk-button-success"><i class="uk-icon-edit"></i> Modifica Idea</button>
                            ...
                            <form action="dettagli_idea.php" method="post">
                              ...
                              <button class="uk-button uk-button-danger"><i class="uk-icon-eraser"></i> Cancella Idea</button>
